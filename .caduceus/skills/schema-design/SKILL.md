...
name: schema-design
version: "1.0"
description: Schema Design workflow for data tasks with quality and risk controls
categories: [data, caduceus]
triggers: ["design schema", "data model"]
tools: [read_file, edit_file, run_queries]
---

# Schema Design Skill Playbook

1. Clarify the objective for Schema Design and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Schema Design in the data category.
