...
name: refactor
version: "1.0"
description: Refactor workflow for code-quality tasks with quality and risk controls
categories: [code-quality, caduceus]
triggers: ["refactor this", "clean this module"]
tools: [read_file, grep_search, edit_file]
---

# Refactor Skill Playbook

1. Clarify the objective for Refactor and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Refactor in the code-quality category.
