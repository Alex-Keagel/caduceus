...
name: query-optimize
version: "1.0"
description: Query Optimize workflow for data tasks with quality and risk controls
categories: [data, caduceus]
triggers: ["optimize query", "slow sql"]
tools: [read_file, edit_file, run_queries]
---

# Query Optimize Skill Playbook

1. Clarify the objective for Query Optimize and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Query Optimize in the data category.
