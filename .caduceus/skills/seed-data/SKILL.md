...
name: seed-data
version: "1.0"
description: Seed Data workflow for data tasks with quality and risk controls
categories: [data, caduceus]
triggers: ["generate seed data", "bootstrap data"]
tools: [read_file, edit_file, run_queries]
---

# Seed Data Skill Playbook

1. Clarify the objective for Seed Data and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Seed Data in the data category.
