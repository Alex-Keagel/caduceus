...
name: migration
version: "1.0"
description: Migration workflow for backend tasks with quality and risk controls
categories: [backend, caduceus]
triggers: ["database migration", "schema migration"]
tools: [read_file, edit_file, run_tests]
---

# Migration Skill Playbook

1. Clarify the objective for Migration and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Migration in the backend category.
