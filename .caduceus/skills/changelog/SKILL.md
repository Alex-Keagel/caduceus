...
name: changelog
version: "1.0"
description: Changelog workflow for documentation tasks with quality and risk controls
categories: [documentation, caduceus]
triggers: ["update changelog", "release notes"]
tools: [read_file, edit_file, search_docs]
---

# Changelog Skill Playbook

1. Clarify the objective for Changelog and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Changelog in the documentation category.
