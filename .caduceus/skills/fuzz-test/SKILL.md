...
name: fuzz-test
version: "1.0"
description: Fuzz Test workflow for testing tasks with quality and risk controls
categories: [testing, caduceus]
triggers: ["fuzz this input", "property testing"]
tools: [read_file, run_tests, edit_file]
---

# Fuzz Test Skill Playbook

1. Clarify the objective for Fuzz Test and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Fuzz Test in the testing category.
