...
name: complexity
version: "1.0"
description: Complexity workflow for code-quality tasks with quality and risk controls
categories: [code-quality, caduceus]
triggers: ["reduce complexity", "simplify function"]
tools: [read_file, grep_search, edit_file]
---

# Complexity Skill Playbook

1. Clarify the objective for Complexity and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Complexity in the code-quality category.
