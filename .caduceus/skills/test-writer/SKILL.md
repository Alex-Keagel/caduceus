...
name: test-writer
version: "1.0"
description: Test Writer workflow for testing tasks with quality and risk controls
categories: [testing, caduceus]
triggers: ["write tests", "add unit tests"]
tools: [read_file, run_tests, edit_file]
---

# Test Writer Skill Playbook

1. Clarify the objective for Test Writer and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Test Writer in the testing category.
