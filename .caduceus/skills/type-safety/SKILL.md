...
name: type-safety
version: "1.0"
description: Type Safety workflow for code-quality tasks with quality and risk controls
categories: [code-quality, caduceus]
triggers: ["improve type safety", "type errors"]
tools: [read_file, grep_search, edit_file]
---

# Type Safety Skill Playbook

1. Clarify the objective for Type Safety and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Type Safety in the code-quality category.
