...
name: component-gen
version: "1.0"
description: Component Gen workflow for frontend tasks with quality and risk controls
categories: [frontend, caduceus]
triggers: ["generate component", "new ui component"]
tools: [read_file, edit_file, run_tests]
---

# Component Gen Skill Playbook

1. Clarify the objective for Component Gen and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Component Gen in the frontend category.
