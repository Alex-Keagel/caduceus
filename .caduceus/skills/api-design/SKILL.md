...
name: api-design
version: "1.0"
description: Api Design workflow for backend tasks with quality and risk controls
categories: [backend, caduceus]
triggers: ["design api", "api contract"]
tools: [read_file, edit_file, run_tests]
---

# Api Design Skill Playbook

1. Clarify the objective for Api Design and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Api Design in the backend category.
