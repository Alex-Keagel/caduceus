...
version: "1.0"
description: Dependency Check workflow for security tasks with quality and risk controls
categories: [security, caduceus]
triggers: ["check dependencies", "vulnerable packages"]
tools: [read_file, grep_search, dependency_audit]
---

# Dependency Check Skill Playbook

1. Clarify the objective for Dependency Check and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Dependency Check in the security category.
