...
name: secret-scan
version: "1.0"
description: Secret Scan workflow for security tasks with quality and risk controls
categories: [security, caduceus]
triggers: ["scan for secrets", "credential leak"]
tools: [read_file, grep_search, dependency_audit]
---

# Secret Scan Skill Playbook

1. Clarify the objective for Secret Scan and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Secret Scan in the security category.
