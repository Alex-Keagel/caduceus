...
name: code-review
version: "1.0"
description: Code Review workflow for code-quality tasks with quality and risk controls
...
1. Clarify the objective for Code Review and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Code Review in the code-quality category.
