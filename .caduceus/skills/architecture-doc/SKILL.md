...
version: "1.0"
description: Architecture Doc workflow for documentation tasks with quality and risk controls
categories: [documentation, caduceus]
triggers: ["document architecture", "system overview"]
tools: [read_file, edit_file, search_docs]
---

# Architecture Doc Skill Playbook

1. Clarify the objective for Architecture Doc and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Architecture Doc in the documentation category.
