...
name: imports
version: "1.0"
description: Imports workflow for code-quality tasks with quality and risk controls
categories: [code-quality, caduceus]
triggers: ["fix imports", "organize imports"]
tools: [read_file, grep_search, edit_file]
---

# Imports Skill Playbook

1. Clarify the objective for Imports and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Imports in the code-quality category.
