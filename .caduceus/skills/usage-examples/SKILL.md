...
name: usage-examples
version: "1.0"
description: Usage Examples workflow for documentation tasks with quality and risk controls
categories: [documentation, caduceus]
triggers: ["add examples", "usage snippets"]
tools: [read_file, edit_file, search_docs]
---

# Usage Examples Skill Playbook

1. Clarify the objective for Usage Examples and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Usage Examples in the documentation category.
