...
name: snapshot-test
version: "1.0"
description: Snapshot Test workflow for testing tasks with quality and risk controls
categories: [testing, caduceus]
triggers: ["add snapshot tests", "snapshot update"]
tools: [read_file, run_tests, edit_file]
---

# Snapshot Test Skill Playbook

1. Clarify the objective for Snapshot Test and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Snapshot Test in the testing category.
