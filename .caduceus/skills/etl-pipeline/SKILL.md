...
name: etl-pipeline
version: "1.0"
description: Etl Pipeline workflow for data tasks with quality and risk controls
categories: [data, caduceus]
triggers: ["build etl", "data pipeline"]
tools: [read_file, edit_file, run_queries]
---

# Etl Pipeline Skill Playbook

1. Clarify the objective for Etl Pipeline and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Etl Pipeline in the data category.
