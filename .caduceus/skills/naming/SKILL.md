...
name: naming
version: "1.0"
description: Naming workflow for code-quality tasks with quality and risk controls
categories: [code-quality, caduceus]
triggers: ["rename symbols", "improve naming"]
tools: [read_file, grep_search, edit_file]
---

# Naming Skill Playbook

1. Clarify the objective for Naming and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Naming in the code-quality category.
