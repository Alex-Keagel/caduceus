...
name: caching
version: "1.0"
description: Caching workflow for backend tasks with quality and risk controls
categories: [backend, caduceus]
triggers: ["add caching", "cache strategy"]
tools: [read_file, edit_file, run_tests]
---

# Caching Skill Playbook

1. Clarify the objective for Caching and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Caching in the backend category.
