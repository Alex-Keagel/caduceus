...
name: responsive
version: "1.0"
description: Responsive workflow for frontend tasks with quality and risk controls
categories: [frontend, caduceus]
triggers: ["responsive design", "mobile layout"]
tools: [read_file, edit_file, run_tests]
---

# Responsive Skill Playbook

1. Clarify the objective for Responsive and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Responsive in the frontend category.
