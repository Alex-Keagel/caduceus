...
name: e2e-test
version: "1.0"
description: E2E Test workflow for testing tasks with quality and risk controls
categories: [testing, caduceus]
triggers: ["create e2e tests", "end to end test"]
tools: [read_file, run_tests, edit_file]
---

# E2E Test Skill Playbook

1. Clarify the objective for E2E Test and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to E2E Test in the testing category.
