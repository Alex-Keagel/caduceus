...
name: error-handling
version: "1.0"
description: Error Handling workflow for code-quality tasks with quality and risk controls
categories: [code-quality, caduceus]
triggers: ["improve error handling", "handle failures"]
tools: [read_file, grep_search, edit_file]
---

# Error Handling Skill Playbook

1. Clarify the objective for Error Handling and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Error Handling in the code-quality category.
