...
name: style-guide
version: "1.0"
description: Style Guide workflow for frontend tasks with quality and risk controls
categories: [frontend, caduceus]
triggers: ["create style guide", "design system rules"]
tools: [read_file, edit_file, run_tests]
---

# Style Guide Skill Playbook

1. Clarify the objective for Style Guide and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Style Guide in the frontend category.
