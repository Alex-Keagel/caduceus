...
name: k8s-manifest
version: "1.0"
description: K8S Manifest workflow for devops tasks with quality and risk controls
categories: [devops, caduceus]
triggers: ["kubernetes manifest", "deploy to k8s"]
tools: [read_file, edit_file, run_shell]
---

# K8S Manifest Skill Playbook

1. Clarify the objective for K8S Manifest and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to K8S Manifest in the devops category.
