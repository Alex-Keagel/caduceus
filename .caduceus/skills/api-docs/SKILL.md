...
name: api-docs
version: "1.0"
description: Api Docs workflow for documentation tasks with quality and risk controls
categories: [documentation, caduceus]
triggers: ["document api", "generate api docs"]
tools: [read_file, edit_file, search_docs]
---

# Api Docs Skill Playbook

1. Clarify the objective for Api Docs and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Api Docs in the documentation category.
