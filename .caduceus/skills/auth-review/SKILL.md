...
name: auth-review
version: "1.0"
description: Auth Review workflow for security tasks with quality and risk controls
categories: [security, caduceus]
triggers: ["review auth", "authorization bugs"]
tools: [read_file, grep_search, dependency_audit]
---

# Auth Review Skill Playbook

1. Clarify the objective for Auth Review and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Auth Review in the security category.
