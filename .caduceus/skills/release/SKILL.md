...
name: release
version: "1.0"
description: Release workflow for devops tasks with quality and risk controls
categories: [devops, caduceus]
triggers: ["prepare release", "release process"]
tools: [read_file, edit_file, run_shell]
---

# Release Skill Playbook

1. Clarify the objective for Release and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Release in the devops category.
