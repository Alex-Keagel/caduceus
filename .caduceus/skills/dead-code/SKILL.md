...
name: dead-code
version: "1.0"
description: Dead Code workflow for code-quality tasks with quality and risk controls
categories: [code-quality, caduceus]
triggers: ["remove dead code", "find unused code"]
tools: [read_file, grep_search, edit_file]
---

# Dead Code Skill Playbook

1. Clarify the objective for Dead Code and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Dead Code in the code-quality category.
