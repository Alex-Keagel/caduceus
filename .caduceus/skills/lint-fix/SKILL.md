...
name: lint-fix
version: "1.0"
description: Lint Fix workflow for code-quality tasks with quality and risk controls
categories: [code-quality, caduceus]
triggers: ["fix lint", "resolve lint errors"]
tools: [read_file, grep_search, edit_file]
---

# Lint Fix Skill Playbook

1. Clarify the objective for Lint Fix and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Lint Fix in the code-quality category.
