...
version: "1.0"
description: Regression Test workflow for testing tasks with quality and risk controls
categories: [testing, caduceus]
triggers: ["add regression test", "prevent regressions"]
tools: [read_file, run_tests, edit_file]
---

# Regression Test Skill Playbook

1. Clarify the objective for Regression Test and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Regression Test in the testing category.
