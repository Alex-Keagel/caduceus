...
name: dockerfile
version: "1.0"
description: Dockerfile workflow for devops tasks with quality and risk controls
categories: [devops, caduceus]
triggers: ["create dockerfile", "containerize app"]
tools: [read_file, edit_file, run_shell]
---

# Dockerfile Skill Playbook

1. Clarify the objective for Dockerfile and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Dockerfile in the devops category.
