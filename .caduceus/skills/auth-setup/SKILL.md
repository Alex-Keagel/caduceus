...
name: auth-setup
version: "1.0"
description: Auth Setup workflow for backend tasks with quality and risk controls
categories: [backend, caduceus]
triggers: ["setup authentication", "add auth"]
tools: [read_file, edit_file, run_tests]
---

# Auth Setup Skill Playbook

1. Clarify the objective for Auth Setup and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Auth Setup in the backend category.
