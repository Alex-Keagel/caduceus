...
name: crud-gen
version: "1.0"
description: Crud Gen workflow for backend tasks with quality and risk controls
categories: [backend, caduceus]
triggers: ["generate crud", "crud endpoints"]
tools: [read_file, edit_file, run_tests]
---

# Crud Gen Skill Playbook

1. Clarify the objective for Crud Gen and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Crud Gen in the backend category.
