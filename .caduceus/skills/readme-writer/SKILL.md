...
name: readme-writer
version: "1.0"
description: Readme Writer workflow for documentation tasks with quality and risk controls
categories: [documentation, caduceus]
triggers: ["write readme", "improve readme"]
tools: [read_file, edit_file, search_docs]
---

# Readme Writer Skill Playbook

1. Clarify the objective for Readme Writer and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Readme Writer in the documentation category.
