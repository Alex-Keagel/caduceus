...
version: "1.0"
description: Data Validation workflow for data tasks with quality and risk controls
categories: [data, caduceus]
triggers: ["validate dataset", "data quality checks"]
tools: [read_file, edit_file, run_queries]
---

# Data Validation Skill Playbook

1. Clarify the objective for Data Validation and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Data Validation in the data category.
