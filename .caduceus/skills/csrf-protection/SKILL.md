...
version: "1.0"
description: Csrf Protection workflow for security tasks with quality and risk controls
categories: [security, caduceus]
triggers: ["csrf check", "anti csrf"]
tools: [read_file, grep_search, dependency_audit]
---

# Csrf Protection Skill Playbook

1. Clarify the objective for Csrf Protection and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Csrf Protection in the security category.
