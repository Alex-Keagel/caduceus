...
name: perf-audit
version: "1.0"
description: Perf Audit workflow for frontend tasks with quality and risk controls
categories: [frontend, caduceus]
triggers: ["frontend performance", "web vitals"]
tools: [read_file, edit_file, run_tests]
---

# Perf Audit Skill Playbook

1. Clarify the objective for Perf Audit and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Perf Audit in the frontend category.
