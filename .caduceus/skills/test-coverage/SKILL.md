...
name: test-coverage
version: "1.0"
description: Test Coverage workflow for testing tasks with quality and risk controls
categories: [testing, caduceus]
triggers: ["increase coverage", "coverage gaps"]
tools: [read_file, run_tests, edit_file]
---

# Test Coverage Skill Playbook

1. Clarify the objective for Test Coverage and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Test Coverage in the testing category.
