...
name: benchmark
version: "1.0"
description: Benchmark workflow for testing tasks with quality and risk controls
categories: [testing, caduceus]
triggers: ["benchmark this", "measure performance"]
tools: [read_file, run_tests, edit_file]
---

# Benchmark Skill Playbook

1. Clarify the objective for Benchmark and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Benchmark in the testing category.
