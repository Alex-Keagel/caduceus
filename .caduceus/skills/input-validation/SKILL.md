...
version: "1.0"
description: Input Validation workflow for security tasks with quality and risk controls
categories: [security, caduceus]
triggers: ["validate input", "sanitize payload"]
tools: [read_file, grep_search, dependency_audit]
---

# Input Validation Skill Playbook

1. Clarify the objective for Input Validation and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Input Validation in the security category.
