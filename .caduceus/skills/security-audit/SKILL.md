...
name: security-audit
version: "1.0"
description: Security Audit workflow for security tasks with quality and risk controls
categories: [security, caduceus]
triggers: ["security audit", "find vulnerabilities"]
tools: [read_file, grep_search, dependency_audit]
---

# Security Audit Skill Playbook

1. Clarify the objective for Security Audit and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Security Audit in the security category.
