...
name: terraform
version: "1.0"
description: Terraform workflow for devops tasks with quality and risk controls
categories: [devops, caduceus]
triggers: ["write terraform", "infra as code"]
tools: [read_file, edit_file, run_shell]
---

# Terraform Skill Playbook

1. Clarify the objective for Terraform and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Terraform in the devops category.
