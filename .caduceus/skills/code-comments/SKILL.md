...
name: code-comments
version: "1.0"
description: Code Comments workflow for documentation tasks with quality and risk controls
categories: [documentation, caduceus]
triggers: ["add code comments", "explain complex code"]
tools: [read_file, edit_file, search_docs]
---

# Code Comments Skill Playbook

1. Clarify the objective for Code Comments and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Code Comments in the documentation category.
