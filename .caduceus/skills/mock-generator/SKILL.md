...
name: mock-generator
version: "1.0"
description: Mock Generator workflow for testing tasks with quality and risk controls
categories: [testing, caduceus]
triggers: ["generate mocks", "mock dependencies"]
tools: [read_file, run_tests, edit_file]
---

# Mock Generator Skill Playbook

1. Clarify the objective for Mock Generator and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Mock Generator in the testing category.
