...
name: ci-pipeline
version: "1.0"
description: Ci Pipeline workflow for devops tasks with quality and risk controls
categories: [devops, caduceus]
triggers: ["setup ci", "pipeline config"]
tools: [read_file, edit_file, run_shell]
---

# Ci Pipeline Skill Playbook

1. Clarify the objective for Ci Pipeline and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Ci Pipeline in the devops category.
