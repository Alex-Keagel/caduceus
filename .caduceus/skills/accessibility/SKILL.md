...
name: accessibility
version: "1.0"
description: Accessibility workflow for frontend tasks with quality and risk controls
categories: [frontend, caduceus]
triggers: ["accessibility audit", "a11y fixes"]
tools: [read_file, edit_file, run_tests]
---

# Accessibility Skill Playbook

1. Clarify the objective for Accessibility and restate expected outcomes, risks, and scope boundaries.
...
20. Close with follow-up recommendations specific to Accessibility in the frontend category.
